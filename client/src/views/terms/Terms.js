    ...
    <>
      <div>
        ...
        <p>
          ...
          our site you agree to the procedures described in these policies. Any
          changes in procedures will be described immediately on this page. So
          our team encourages themselves to be well aware of this.
        </p>
        <ol>
          <li>
            Our website section stores the name, address, contact information,
            etc. that our visitors voluntarily provide.
          </li>
          <li>
            The stored information will be used to fulfill their specific
            requests and to be in touch with us when we need them.
          </li>
          <li>
            For whatever reason their information we have will not be shared
            with third parties or companies.
          </li>
          <li>
            We will be sending whatsapp messages to the provided mobile number
            for verification code and order notifications{' '}
          </li>
          <li>
            Not sharing information such as their password with anyone will
            avoid unnecessary hassles
          </li>
          <li>
            Their information will be secure in our company. Only the web
            section of our company is set up to access and handle their
            information.
          </li>
        </ol>
        ...
        <ol>
          <li>
            We usually take 4 to 6 days to deliver the item to you from the date
            you requested. Total orders take one or two more days.
          </li>
