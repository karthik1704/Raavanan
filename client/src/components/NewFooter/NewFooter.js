  ...
  return (
    ...
    <Grid item xs={12} sm={4} xl={4} md={4}>
     <div className="Footer_First_block">
       ...
       சங்கம் வைத்து வளர்த்த மாமதுரையில் தமது முதன்மைக் கிளையைக் கொண்டு செயலாற்றி வருகிறது.மிகச் சிறந்த ஒரு இணையதள அங்காடியை தமிழில் தமிழகத்தில் உருவாக்கிக் காட்டவேண்டும் என்பதே இராவணன் அங்காடியின் மேலான நோக்கம். இது ஒரு தமிழ்நாட்டுத் தயாரிப்பு என்று முழங்குவதில் நிகரற்ற பெருமை கொள்கிறது எமது குழு.
       </p>
     </div>
        </Grid>
       ...
       <p className="first_block_description">
       எந்த ஒரு சமூக வலைத்தலங்களிலும் இராவணன் அங்காடியின் பக்கங்களில் குறுஞ்செய்தி அனுப்பியும் தொடர்பு கொள்ளலாம்.
       </p>
     </div>
        </Grid>
